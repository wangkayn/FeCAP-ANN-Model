"""
Random Forest baseline for FeCAP polarization prediction.

Data requirements: see ann_model.py docstring for the expected Excel format.

Usage:
    python baseline_rf.py --data your_data.xlsx
"""
import argparse
import numpy as np
import pandas as pd
...
if __name__ == '__main__':
    ...
    m = results['combined']
    print(f"{'Random Forest':<20} {m['MSE']:.6f}  {m['RMSE']:.6f}  {m['MAE']:.6f}  {m['Adj_R2']:.6f}")
